---
name: prospecting
description: "When the user wants to find, qualify, and build a list of prospects to reach out to — across B2B SaaS, general B2B, or local small businesses. Also…"
metadata:
  version: 1.1.0
---
