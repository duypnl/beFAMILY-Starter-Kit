---
name: marketing-plan
description: "When the user needs a comprehensive marketing plan for a client, a company they advise, or their own product. Also use when the user mentions…"
metadata:
  version: 1.1.1
---
