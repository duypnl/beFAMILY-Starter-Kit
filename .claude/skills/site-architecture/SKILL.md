...
description: "When the user wants to plan, map, or restructure their website's page hierarchy, navigation, URL structure, or internal linking. Also use when the…"
metadata:
  version: 2.0.0
---
